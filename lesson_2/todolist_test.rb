...
class TodoListTest < MiniTest::Test
  ...
  def test_each_original?
    result = @list.each {|element| element}
    assert_equal(result.object_id, @list.object_id)
  end
  ...
  def test_select
    ...
    assert_equal(temp.to_s, result.to_s)
  end
end 